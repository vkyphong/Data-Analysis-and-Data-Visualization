...
*"Các yếu tố về thời gian, sân bay khởi hành, tuyến bay và nguyên nhân vận hành có mối liên hệ như thế nào đến tình trạng trễ chuyến của Delta Air Lines, và Delta nên ưu tiên cải thiện ở đâu để nâng cao tỷ lệ đúng giờ trước mùa cao điểm?"*
...
Xét theo sân bay khởi hành, trong 157 sân bay Delta khai thác, có 92 sân bay đạt ngưỡng tối thiểu 1.000 chuyến/năm được xem là sân bay có sản lượng khai thác lớn theo ngưỡng nghiên cứu (không phải định nghĩa hub chính thức theo mạng bay). Trong nhóm này, **LGA (LaGuardia, New York)** có tỷ lệ trễ cao nhất: 21,9%, cao hơn trung bình toàn Delta khoảng 8,4 điểm phần trăm (chênh lệch tính trên số liệu chưa làm tròn). Đáng chú ý, các sân bay đứng đầu nhóm rủi ro cao đều tập trung ở khu vực Đông Bắc và các thành phố lớn có mật độ không lưu cao (LGA, JFK, BOS, ORD), kết quả này cho thấy đây là các khu vực đáng được ưu tiên kiểm tra sâu hơn về điều kiện khai thác và năng lực vận hành.

Ở cấp độ tuyến bay, sau khi loại 75.458 quan sát có ít nhất một mã sân bay không hợp lệ (8,67% số quan sát trong tập đủ điều kiện), dữ liệu còn lại được dùng để xây dựng các tuyến bay thực tế. Việc loại các quan sát này chỉ áp dụng cho phân tích sân bay/tuyến bay; không ảnh hưởng đến tỷ lệ trễ tổng thể của Delta vì các chuyến vẫn được giữ trong tập phân tích tổng quan nếu đáp ứng đầy đủ điều kiện; khi tính tỷ lệ trễ theo tuyến, chỉ các chuyến có `IS_DELAYED` hợp lệ mới được đưa vào mẫu số. Từ 963 tuyến thật, có 448 tuyến đạt ngưỡng tối thiểu 500 chuyến. Tuyến rủi ro cao nhất là **SFO–LAX** (San Francisco – Los Angeles): 45,8% trên 1.352 chuyến — cao vượt trội so với phần còn lại. Đặc biệt, chiều ngược lại **LAX–SFO** cũng lọt vào vị trí thứ 2 (36,8% trên 1.351 chuyến), cho thấy cả hai chiều của cùng một cặp thành phố đều có rủi ro cao. Nguyên nhân cụ thể của hiện tượng này cần được kiểm tra thêm theo thời tiết, lịch khai thác và các yếu tố vận hành — dữ liệu hiện có chưa đủ để kết luận nguyên nhân.
...
**Biểu đồ 2 — Tỷ lệ trễ theo sân bay khởi hành, Top 15 sân bay sản lượng cao (Bar chart):** LGA có tỷ lệ trễ cao nhất (21,9%), vượt trung bình toàn Delta 8,4 điểm % (tính trên số liệu chưa làm tròn); các sân bay khu vực Đông Bắc (LGA, JFK, BOS) chiếm phần lớn nhóm rủi ro cao nhất.

**Biểu đồ 3 — Route Risk: khối lượng khai thác so với tỷ lệ trễ (Scatter chart):** Trong 448 tuyến đạt ngưỡng thống kê, SFO–LAX rủi ro cao nhất (45,8% trên 1.352 chuyến), theo sau bởi chính chiều ngược LAX–SFO (36,8%) — hai chiều của cùng một cặp thành phố cùng lọt top 2.
...
Phân tích 5 nhóm nguyên nhân trễ cho thấy đối với riêng Delta, nhóm nguyên nhân liên quan đến hãng hàng không (`AIRLINE_DELAY`) chiếm tỷ trọng lớn nhất: 37,4% tổng phút trễ, tiếp theo là trễ dây chuyền do máy bay đến trễ chuyến trước (`LATE_AIRCRAFT_DELAY`, 29,5%) và hệ thống không lưu quốc gia (`AIR_SYSTEM_DELAY`, 24,6%). Thời tiết chiếm 8,3% và an ninh không đáng kể (0,1%). Trong tập dữ liệu Delta được phân tích, AIRLINE_DELAY là nhóm nguyên nhân chiếm tỷ trọng lớn nhất. Dữ liệu không nêu rõ thành phần cụ thể của `AIRLINE_DELAY` (ví dụ bảo trì, nhân sự...), nên nhóm không suy diễn thêm ngoài phạm vi được dataset ghi nhận.
...
| F4 | Sân bay | Sân bay khởi hành có tỷ lệ trễ cao nhất | LGA — 21,9% (cao hơn TB 8,4 điểm %) |
| F5 | Tuyến bay | Tuyến rủi ro cao nhất (≥500 chuyến) | SFO–LAX — 45,8% trên 1.352 chuyến |
